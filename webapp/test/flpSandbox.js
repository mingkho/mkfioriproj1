		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My App",
									"targetURL": "#mkfioriproj1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mkfioriproj1-display": {
								"semanticObject": "mkfioriproj1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mkfioriproj1",
									"url": sap.ui.require.toUrl("mkfioriproj1")
								}
							}
						}
					}
